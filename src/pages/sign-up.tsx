      ...
      <form className={"form"} onSubmit={handleSubmit(onSubmit)}>
        ...
        <InputGroup
          {...register("confirmPassword", {
            required: FormValidator.required("Confirm Password"),
            minLength: FormValidator.minLength("Confirm Password", 6),
            maxLength: FormValidator.maxLength("Confirm Password", 18),
            pattern: FormValidator.password("Confirm Password"),
            validate: (value) =>
              FormValidator.validatePasswordMatch(value, watch("password")),
          })}
          label={t("Confirm Password")}
          type={showConfirmPassword ? "text" : "password"}
          name="confirmPassword"
          required
          placeholder={t("Confirm Password input")}
          errors={errors}
